  ...
  return (
    <header className="h-16 bg-surface border-b border-border flex items-center justify-between px-4 lg:px-6 sticky top-0 z-40">
      ...
      <div className="flex items-center gap-2">
        <Link
          to="/docs"
          className="hidden sm:flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-semibold text-text-muted hover:text-text-primary hover:bg-surfaceHover transition-all border border-border hover:border-orange/40"
          title="Documentation"
        >
